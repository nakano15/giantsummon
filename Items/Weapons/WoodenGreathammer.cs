...
namespace giantsummon.Items.Weapons
{
    public class WoodenGreathammer : GuardianItemPrefab
	{
		...
		{
			Tooltip.SetDefault("My arms aren't strong enough to use this, but...");  //The (English) text shown below your weapon's name
		}
		...
		public override void SetDefaults()
		{
			...
			item.height = 92;           //Weapon's texture's height
			item.useTime = 48;          //The time span of using the weapon. Remember in terraria, 60 frames is a second.
			item.useAnimation = 48;         //The time span of the using animation of the weapon, suggest set it the same as useTime.
