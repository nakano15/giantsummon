...
namespace giantsummon.Items.Weapons
{
    public class MeatMasher : GuardianItemPrefab
	{
		...
		{
			Tooltip.SetDefault("Good at flattening jobs.");  //The (English) text shown below your weapon's name
		}

		public override void SetDefaults()
		{
			item.damage = 46;           //The damage of your weapon
			item.melee = true;          //Is your weapon a melee weapon?
			item.width = 48;            //Weapon's texture's width
			item.height = 94;           //Weapon's texture's height
