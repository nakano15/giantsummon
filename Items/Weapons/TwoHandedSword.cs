...
namespace giantsummon.Items.Weapons
{
    public class TwoHandedSword : GuardianItemPrefab
	{
		...
		public override void SetDefaults()
		{
			...
			item.useTime = 42;          //The time span of using the weapon. Remember in terraria, 60 frames is a second.
			item.useAnimation = 42;         //The time span of the using animation of the weapon, suggest set it the same as useTime.
