...
{
    public class HugeHellmet : GuardianItemPrefab
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("This matches the rest of the set?");  //The (English) text shown below your weapon's name
		}
		...
		public override void AddRecipes()
		{
            ...
            recipe.AddIngredient(Terraria.ID.ItemID.HellstoneBar, 25);
