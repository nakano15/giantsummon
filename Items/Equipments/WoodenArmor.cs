...
{
    public class WoodenArmor : GuardianItemPrefab
	{
		public override void SetStaticDefaults()
		{
			Tooltip.SetDefault("The only thing that degrade this armor defense, are termites.");  //The (English) text shown below your weapon's name
		}
		...
		public override void AddRecipes()
        {
            ...
            recipe.AddIngredient(Terraria.ID.ItemID.Wood, 65);
            recipe.anyWood = true;
