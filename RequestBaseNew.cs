...
namespace giantsummon
{
    public class RequestBaseNew
    {
        ...
        public virtual string RequestObjective(RequestDataNew data)
        {
            return "Unknown";
        }

        public virtual string RequestShortDescription(RequestDataNew data)
        {
            return "do something";
        }
        ...
        public virtual void UpdateRequest(Player player, RequestDataNew data)
        {

        }

        public virtual void OnKillMob(NPC npc, RequestDataNew data)
        {

        }

        public virtual void OnCompleteRequest(Player player, RequestDataNew data)
        {

        }
    }

    public class HuntRequestBase : RequestBaseNew
    {
        public int NpcID = 0;
        ...
        public override string RequestObjective(RequestDataNew data)
        {
            if(data.IsComplete)
            {
                return "Report back to " + data.RequestGiver.Name + ".";
            }
            return "Slay "+data.ObjectiveCount+" " + MainMod.PluralifyWord(NpcName) + ".";
        }

        public override string RequestShortDescription(RequestDataNew data)
        {
            return "slay " + data.MaxObjectiveCount + " " + MainMod.PluralifyWord(NpcName);
        }

        public override void OnKillMob(NPC npc, RequestDataNew data)
        {
    ...
    public class ItemRequestBase : RequestBaseNew
    {
        public int ItemID = 0;
        ...
        public override void UpdateRequest(Player player, RequestDataNew data)
        {
            int ItemCount = 0;
            for(int i = 0; i < 58; i++)
            {
        ...
        public override void OnCompleteRequest(Player player, RequestDataNew data)
        {
    ...
    public class TravelRequestBase : RequestBaseNew
    {
        ...
        public override int GetRequestObjectiveCount(int FriendshipLevel)
        {
            return (1000 + ExtraDistance + 100 * FriendshipLevel) * 100;
        }
    }
}
